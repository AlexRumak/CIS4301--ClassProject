...
app.set('views', __dirname + '/app/public/views'); // Set the views directory
app.use(express.static(__dirname + '/app/public')); // Set the directory to serve static files (CSS, images, etc.)
